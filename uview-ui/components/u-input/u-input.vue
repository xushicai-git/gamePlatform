<template>
	<view
		...
		@tap.stop="inputClick"
	>
		<view class="icon-wapper" v-if="preIcon">
			<image :src="preIcon" class="icon-pre" mode="aspectFit"></image>
		</view>
		<slot name="left"></slot>
		<textarea
			v-if="type == 'textarea'"
...
.u-input {
	...
	&--border {
		border-radius: 20rpx;
		border: 8rpx solid $u-form-item-border-color;
		background-color: #312E46;
	}
	&--border2 {
		border-radius: 20rpx;
		border: 8rpx solid #190062 !important;
